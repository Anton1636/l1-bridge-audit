...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
     ...
     */
    // @audit-high - if a user approves the bridge, any other user can steal their found
    // @audit-high - if the vault approves the bridge, ca a user can steal their found from the vault
